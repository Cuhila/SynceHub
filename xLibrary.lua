...
-- Theme Colors (macOS style) - UPDATED
local Theme = {
    Background = Color3.fromRGB(245, 245, 250),
    Header = Color3.fromRGB(250, 250, 252),
    Sidebar = Color3.fromRGB(245, 245, 250), -- SAMA DENGAN BACKGROUND
...
function Library:CreateWindow(config)
    ...
    local WindowSize = config.Size or UDim2.new(0, 500, 0, 320) -- HORIZONTAL SIZE
    ...
    -- Window Controls Container (KANAN) - MOVED TO RIGHT
    local Controls = Instance.new("Frame")
    Controls.Name = "Controls"
    Controls.Size = UDim2.new(0, 70, 1, 0)
    Controls.Position = UDim2.new(1, -82, 0, 0) -- POSITIONED AT RIGHT
    ...
    CloseBtn.Position = UDim2.new(0, 58, 0.5, -6) -- RIGHTMOST
    ...
    MinimizeBtn.Position = UDim2.new(0, 20, 0.5, -6) -- MIDDLE
    ...
    -- Maximize Button (Green) - LEFT OF CLOSE
    local MaximizeBtn = Instance.new("TextButton")
    MaximizeBtn.Name = "Maximize"
    MaximizeBtn.Size = UDim2.new(0, 12, 0, 12)
    MaximizeBtn.Position = UDim2.new(0, 39, 0.5, -6) -- LEFT OF CLOSE
    ...
    -- Main Container (HORIZONTAL Layout - Tabs on Top, Content Below)
    ...
    TabBar.Name = "TabBar"
    TabBar.Size = UDim2.new(1, 0, 0, 45) -- HORIZONTAL BAR
    ...
    -- Tab Container (HORIZONTAL ScrollingFrame)
    ...
    TabContainer.ScrollingDirection = Enum.ScrollingDirection.X -- HORIZONTAL SCROLL
    TabContainer.CanvasSize = UDim2.new(0, 0, 0, 0)
    TabContainer.Parent = TabBar
    
    local TabLayout = Instance.new("UIListLayout")
    TabLayout.FillDirection = Enum.FillDirection.Horizontal -- HORIZONTAL LAYOUT
    ...
    ContentArea.Size = UDim2.new(1, 0, 1, -45) -- TAKES REMAINING SPACE
    ...
    function WindowFunctions:CreateTab(tabName, icon)
        ...
        TabButton.Size = UDim2.new(0, 90, 0, 32) -- HORIZONTAL TAB SIZE
