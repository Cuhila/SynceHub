-- macOS Style UI Library by Synce - Fixed Version v2
-- Modern, Clean, Mobile-Friendly, Vertical Sidebar
...
-- Theme Colors (macOS style) - DARKER
local Theme = {
...
function Library:CreateWindow(config)
    ...
    local WindowSize = config.Size or UDim2.new(0, 550, 0, 280)
    ...
    NotificationContainer.Size = UDim2.new(0, 240, 1, 0)
    ...
    -- Header Bottom Border (GARIS KELIATAN PAS MINIMIZE)
    ...
    -- Window Controls Container (KANAN)
    ...
    MaximizeBtn.Position = UDim2.new(0, 39, 0.5, -6)
    ...
    CloseBtn.Position = UDim2.new(0, 58, 0.5, -6)
    ...
    -- Notification System (NO OVERLAP - STACKING)
    function WindowFunctions:Notify(config)
        ...
        NotifTitleLabel.Size = UDim2.new(1, -20, 0, 18)
        ...
        NotifTextLabel.Size = UDim2.new(1, -20, 0, 26)
        NotifTextLabel.Position = UDim2.new(0, 10, 0, 30)
